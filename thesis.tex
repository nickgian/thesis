...
\newcommand{\frule}[8]{(#1,#2,#3,#4,#5,#6) \mapsto (#7,#8)}
...
\newcommand{\NXD}[0]{\emph{NXD}}
\newcommand{\NWC}[0]{\emph{NWC}}

\newcommand{\NXDname}[0]{\emph{NXD}\xspace}
\newcommand{\NWCname}[0]{\emph{NWC}\xspace}
