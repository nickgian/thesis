...
described hardware and the two papers claim low overhead (~3\% on
...
50\% energy overhead.  \nick{I can use optimized numbers but they are
  taken out of asplos paper, so I am now just taking numbers out of
  nowhere}
%
