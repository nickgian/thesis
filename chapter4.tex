...
\cref{sec:cfi_fine} \ii{simulates} an abstract machine that has \CFI
...
%Will continue once approved by Catalin because it is time wasting.
\node (n8label) [fill=white,font=\small] at (14,1.5)  {};
\node (trlabel) [fill=white,font=\footnotesize] at (7,1.5) {$tr^H$};
