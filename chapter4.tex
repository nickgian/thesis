...
\ch{TODO: explain the high-level structure of the proofs (again) here}
...
\ch{TODO: give code for CFG, very simple}
...
\subsubsection{Allowed control-flows for the abstract machine}
...
the set of allowed control-flows for all instructions.\ch{Make it clearer
  that this \SUCC is for the abstract machine}
...
\TAGS{\DATA,\INSTR{\ii{id}}, \INSTR{\bot}},\ch{Bring in Inductive}
