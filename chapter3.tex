...
\ch{Shrink and polish this}\nick{done} We follow the standard approach, by
designing a composed micro-policy that enforces \NXD, \NWC and \CFI.  We
considered designs that lifted the \NXD and \NWC restrictions but we
rejected them, for the time being, as there did not seem to be any
...
Consider the set of tags \TAGS{\DATA,\INSTR{\ii{id}}, \INSTR{\bot}}
